...
const projectsList = [
  {
    title: "Ankvidhi",
    description:
      "AI-powered WhatsApp marketing SaaS platform built with Bun + Hono backend and Next.js dashboard. Includes real-time analytics, multilingual chatbot flows, and campaign automation using Meta WhatsApp Cloud API.",
      ...
      <div className="max-w-6xl w-full space-y-10 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          {projectsList.map((project, i) => (
            <div
              key={i}
              className="bg-[#121C26] border-2 border-white/10 rounded-xl p-6 flex flex-col justify-between hover:border-blue-500/50 transition-all duration-300"
            >
              ...
              {project.link && (
                <a
                  ...
                  className=" flex justify-start items-center gap-2 mt-6 text-sm text-blue-400 hover:text-blue-300 font-medium transition-colors group"
                >
                  View Project
                  <ArrowRight
                    size={14}
